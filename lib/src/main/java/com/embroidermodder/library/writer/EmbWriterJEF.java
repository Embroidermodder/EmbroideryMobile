...
import com.embroidermodder.library.EmbThreadJef;
import com.embroidermodder.library.TransCoder;
...
public class EmbWriterJEF extends EmbWriter {
    ...
    public void write() throws IOException {
        ...
        for (EmbThread thread : pattern.getThreadlist()) {
            writeInt32(EmbThread.findNearestIndex(thread.getColor(), threadSet));
        }
